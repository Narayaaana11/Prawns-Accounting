        ...
        <div className="invoice-page" style={{
            ...
            <tbody>
              {invoice.items.map((item, i) => (
                <tr key={i} style={{ borderBottom: "1px solid #f3f4f6", background: i % 2 === 0 ? "white" : "#fafafa" }}>
                  ...
                  <td style={{ padding: "11px 14px", fontSize: "13px", fontWeight: 500, color: "#111827" }}>
                    {item.productName}
                    {item.batchNumber && (
                      <span style={{ marginLeft: "8px", fontSize: "11px", color: "#4b5563", background: "#f3f4f6", padding: "2px 6px", borderRadius: "4px", border: "1px solid #e5e7eb" }}>
          ...
          <div style={{ borderTop: "2px solid #f3f4f6", paddingTop: "20px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <p style={{ fontSize: "11px", color: "#d1d5db" }}>
              Generated by Prawns Accounting
            </p>
          </div>
        </div>
      </div>
